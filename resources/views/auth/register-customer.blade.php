...
@section('content')
  ...
  <main class="register-main-container">
    <section class="register-card customer-register-card">
      <div class="register-card-content">
        ...
        <div class="register-subtitle">
          ...
          <a href="{{ route('customer.login') }}" class="register-signin-link">Sign in</a>
        </div>
        ...
        <form class="register-form" id="registerCustomerForm" method="POST" action="{{ route('register.customer') }}" autocomplete="off">
          @csrf

          <label for="fullname">Full Name</label>
          <input type="text" id="fullname" name="name" class="register-input" required value="{{ old('name') }}" />

          <label for="email">E-mail address</label>
          <input type="email" id="email" name="emailAddress" class="register-input" required value="{{ old('email') }}" />
          ...
          <div class="register-password-wrapper">
            <input type="password" id="repassword" name="password_confirmation" class="register-input" required />
            <span class="register-eye" id="toggleRePassword" tabindex="0">
              <svg id="eyeIcon2" width="22" height="22" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                <ellipse cx="12" cy="12" rx="7" ry="5" />
                <circle cx="12" cy="12" r="2.5" />
              </svg>
            </span>
    ...
    <section class="register-marketing">
      ...
      <div class="register-marketing-features">
        <div class="register-feature">
          ...
          <span class="register-feature-desc">Skip the long forms. Book your ride with just a few taps—fast, simple, and secure.</span>
        </div>
        <div class="register-feature">
          <span class="register-feature-title">Total Control, Your Way</span><br />
          <span class="register-feature-desc">Choose the car you want, when you want it. Flexible rentals with real-time availability.</span>
        </div>
        <div class="register-feature">
          <span class="register-feature-title">Drive with confidence</span><br />
          <span class="register-feature-desc">All cars are verified and insured. We've got your back every mile of the way.</span>
        </div>
      </div>
    </section>
  </main>
